    ...
    return (
        <div className='form-container' >
            <div className="form-heading" style={{background: '#fff'}}>
                ...
                <h2 style={{fontWeight: '400', paddingTop: '16px'}}>Send us a message and you'll hear back from us within two business days.</h2>
            </div>
            <div className="form-body" direction="column" style={{background: '#fff'}}>
                <form>
                    ...
                    <textarea className='bottom-input' type='text' placeholder='Message'  style={{fontSize: '20px', fontFamily: 'Open Sans', fontWeight: '500',  margin: '8px 0', paddingLeft: '16px', background: 'transparent', outline: 'none', border: 'none', borderBottom: '1px solid black'}}/>

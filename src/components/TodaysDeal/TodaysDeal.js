    ...
    <div className="deal-div">
      <div className="deal-wrapper">
        <div className="deal-img">
          ...
          <img
            src={require("../../../public/assets/amd5700.jpg")}
            alt="amd 5700"
          ></img>
        </div>
        <div className="deal-details">
          <div className="deal-name">
            <h1>AMD Radeon 5700</h1>
          </div>
          <div className="deal-price">
            ...
            <h2 style={{ paddingLeft: "16px", fontWeight: "300" }}>$300</h2>
          </div>
          <div className="cta-links">
            <Link to="/products" className="all-products-button">
          ...
          <div className="deal-desc">
            ...
            <ul>
              <li>Brand: ASUS</li>
              <li>Graphics Processor: AMD Radeon RX 5700</li>
              <li>Chipset Brand: AMD</li>
              <li>Graphics Ram Type: GDDR6</li>
              <li>Graphics Ram Size: 8 GB</li>
            </ul>
          </div>
              ...
              <ProductConsumer>
                {(value) => {
                  return value.products.slice(3, 6).map((prod) => {
                    return <ExtraDeal key={prod.id} prod={prod} />;
                  });
                }}
              </ProductConsumer>
            </div>

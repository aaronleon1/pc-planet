                  ...
                  <div className="prod-specs">
                    <Tabs>
                      ...
                      <TabPanel>
                        <ul>
                          ...
                          <li>
                            Add a Square Trade warranty to your purchase at
                            checkout
                          </li>
                        </ul>
                        <img
                          src={require("../../../public/assets/squareTrade.jpg")}
                          alt="square trade warranty"
                    ...
                    {(id >= 1 && id <= 8) || (id >= 16 && id <= 19) ? (
                      <div className="upsell">
                        <Link to="/processors">
                          <img
                            src={require("../../../public/assets/cpuUpsell.jpg")}
                            alt=" "
                  ...
                  <TabPanel>
                    <Carousel breakPoints={breakPoints}>
                      {value.recommendedProducts
                        ...
                        .map((prod) => {
                          return (
                            <RecommendedProductCard key={prod.id} prod={prod} />
                          );
                        })}
                    </Carousel>
                  </TabPanel>
